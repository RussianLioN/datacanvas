# Sprint Backlog: 2026-W27 Backlog Closure

| ID | Item | Acceptance | Статус |
|---|---|---|---|
| EVAL-006 | Зафиксировать шестой eval case в backlog и sync gate | `validate:eval-backlog-sync` проходит | done |
...
`TECH-W27-*`, `PROC-W27-*` и `REL-W27-*` являются sprint-local IDs и не расширяют central backlog registry.
