...
| Artifact registry size | 812 | count(artifact_registry.artifacts) |
| Accepted process changes | 6 | count(process_change_ledger.entries where status == accepted) |
...
| Artifact registry entries | 812 |
| Accepted process changes | 6 |
