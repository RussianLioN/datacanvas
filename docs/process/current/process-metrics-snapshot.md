...
| Artifact registry size | 748 | count(artifact_registry.artifacts) |
| Accepted process changes | 5 | count(process_change_ledger.entries where status == accepted) |
...
| Artifact registry entries | 748 |
| Accepted process changes | 5 |
