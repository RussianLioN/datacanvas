...
| Artifact registry size | 619 | count(artifact_registry.artifacts) |
| Accepted process changes | 4 | count(process_change_ledger.entries where status == accepted) |
...
| Artifact registry entries | 619 |
| Accepted process changes | 4 |
