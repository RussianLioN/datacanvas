...
| Artifact registry size | 875 | count(artifact_registry.artifacts) |
| Accepted process changes | 7 | count(process_change_ledger.entries where status == accepted) |
...
| Artifact registry entries | 875 |
| Accepted process changes | 7 |
