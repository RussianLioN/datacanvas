...
- Текст не выходит за рамки, рамки не пересекаются, интервалы сетки согласованы, все элементы находятся внутри холста.
- В готовом PNG нет темных пикселей текста начиная с первого пикселя за рамками; количество и распределение темных пикселей каждого смыслового блока соответствует свежему каноническому рендеру.
- Для каждого актуального PNG/PDF выполнен свежий рендер из канонического визуального источника; PDF независимо растеризован и покадрово проверен по каждому блоку; исторические снимки не используются как текущее acceptance evidence.
- Для PlantUML и других исходных визуальных форматов проверены ограничения строк и полнота пространственных связей; при появлении отдельного растрового рендера для него добавлена профильная проверка компоновки.
