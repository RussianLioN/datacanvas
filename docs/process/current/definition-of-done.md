...
- Для каждого актуального PNG/PDF выполнен свежий рендер из канонического визуального источника; исторические снимки не используются как текущее acceptance evidence.
