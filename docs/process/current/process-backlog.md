...
| PROC-050 | Блокер: контракт генерации каталога пользовательских историй | Для `docs/stories.md` закрепить генерацию только классического каталога пользовательских историй без источников, ПШЕ, provenance и служебных разделов | governance | 1 | ready | `docs/process/universal-documentation-workflow/business-artifact-generation-contract.json` | `npm run validate:business-docs` |
| PROC-051 | Блокер: контракт генерации формализованных пользовательских историй | Для `docs/product/requirements/user-stories.md` закрепить генерацию формализованных пользовательских историй без технических контрактов, runtime-полей и служебной истории обработки | governance | 1 | ready | `docs/process/universal-documentation-workflow/business-artifact-generation-contract.json` | `npm run validate:business-docs` |
