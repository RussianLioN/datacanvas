...
`PROC-039` добавляет методику проектной документации на основе BABOK-исследования. Методика задает lifecycle от идеи до эксплуатации, artifact policy, обязательную traceability chain, quality gates для бизнес-анализа, системного анализа и AI-агентных решений, а также права агента при изменении документации.

Перед возобновлением интервью о новом требовании заказчика агент проверяет `npm run validate:documentation-methodology` и задает вопросы по одному решению за шаг.
