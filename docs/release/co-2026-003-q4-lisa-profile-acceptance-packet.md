...
> **Исторический пакет:** результаты ниже относятся к выпуску от 18 августа 2026 года. Они не принимают будущий кандидат для ООО «Водолей Трейд». Для него действуют [реестр утверждённых текстов](../product/analysis/presentation-link-lisa-user-journey/owner-approved-texts.md) и [план SVG-пересборки](../plans/co-2026-003-svg-prototype-revision-implementation-plan.md): до покадровой приёмки SVG, PNG, HTML и архив не пересобираются.
