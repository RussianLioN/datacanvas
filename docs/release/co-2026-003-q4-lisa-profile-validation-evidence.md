...
Пока оба одобрения не получены, архив поставки намеренно не создаётся. Его проверка должна прекратить работу до записи ZIP-файла, чтобы не вложить в поставку устаревший прототип.
