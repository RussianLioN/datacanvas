...
| `task-review-presentation-link-lisa-user-journey` | Проверить пользовательский путь заказа, получения и просмотра презентации в Лисе | `product` | `business` | `docs/product/analysis/presentation-link-lisa-user-journey/README.md` | `docs/product/analysis/presentation-link-lisa-user-journey/user-journey.md`, `docs/product/analysis/presentation-link-lisa-user-journey/donor-options.md` | Product Owner / Documentation Owner | `npm run validate:presentation-link-lisa-user-journey:profile` |
