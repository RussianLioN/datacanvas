# Отчет По Orphan Docs И Вложенности
...
| `docs/process/methodology/README.md` | `docs/process/README.md` | `governance` | `public` | `true` | `1` |
| `docs/process/prompt-only-artifact-review/README.md` | `docs/process/README.md` | `governance` | `public` | `true` | `2` |
...
| `docs/product/bmc/README.md` | `docs/product/README.md` | `business` | `public` | `true` | `1` |
| `docs/product/change-orders/README.md` | `docs/product/README.md` | `business` | `public` | `true` | `1` |
