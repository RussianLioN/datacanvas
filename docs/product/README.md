...
адреса только через «Профиль сотрудника», доставка `ODT` и `PDF` по электронной
...
структуры не входят в Q4_2026. Дословно согласованные сообщения сохраняются;
содержание Q4_2026 и визуальный выпуск согласованы владельцем продукта.
Прототип и специальный архив собраны и проверены; поставка включает прототип и
актуальную книгу ресурсов от 2026-08-17.
