...
Владелец принял чистовой браузерный прототип, смену действующего маршрута и
архив поставки. Исторический черновик сохранён только как доказательство RCA и
не является маршрутом для работы.
...
- [Скачать полный архив поставки](../../artifacts/delivery/co-2026-003-q4-lisa-profile-delivery.zip?raw=1) — единый ZIP с актуальной документацией и локальным запуском 11 экранов ООО «Водолей Трейд».
