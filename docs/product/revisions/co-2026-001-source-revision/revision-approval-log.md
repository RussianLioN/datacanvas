...
Продолжать с `EDIT-008` — правки traceability по двум режимам: сначала вывести текущий фрагмент `docs/product/requirements/traceability-matrix.json`, затем предложить варианты правки.
...
Вывести Product Owner текущий фрагмент для `EDIT-008` — правки traceability по двум режимам, затем запросить согласование варианта правки.
