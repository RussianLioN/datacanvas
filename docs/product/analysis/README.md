# Аналитические Артефакты DataCanvas

Навигация: [DataCanvas](../../../README.md) / [Документация](../../README.md) / [Продукт](../README.md) / Аналитика
...
- [Анализ `DC-ST-23..DC-ST-29` — пользовательских историй запуска другим агентом — на влияние на `BT-*` — бизнес-требования](agent-launch-requirements-analysis/README.md)
