...
Статус: три кадра ожидают отдельной приёмки владельца. Ни один из них не
меняет действующую демонстрацию, высокий рендер или архив.
...
Для приёмки каждого кадра достаточно ответа «кадр принят» или конкретного
замечания к нему. После приёмки всех кадров будет подготовлен общий черновик
прототипа в прежнем разрешении.
