...
| Product backlog — продуктовый список работ: `docs/product/backlog/product-backlog.md` | Product planning | draft | Хранит `DC-ST-23..DC-ST-29` как `P1` и `DC-ST-30..DC-ST-33` как `P2` с принятыми приоритетами и ПШЕ из рабочей Excel-редакции; sprint backlog — список работ спринта — ждет проверки емкости, порядка работ, полного BA-опросника DataCanvas и решения по вытеснению работ. |
| Roadmap — дорожная карта: `docs/product/roadmap/roadmap-v0.1.md` | Product planning | draft | Пока не отражает явное перепланирование 3-4 недельных спринтов под запуск другим агентом; перепланирование отложено до BA-опросника и проверки емкости. |
