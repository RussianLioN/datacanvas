...
Пакет хранит состояние, журнал и проверяемые решения по влиянию `DC-ST-23` — пользовательской истории о передаче запроса от другого агента — через `DC-ST-29` — пользовательскую историю о генерации редактируемого файла презентации — на `BT-*` — бизнес-требования.
...
- [Stories — каталог пользовательских историй](../../../stories.md).
...
- `story-requirement-decision-ledger.md` — решения по `DC-ST-23..DC-ST-29` — пользовательским историям-кандидатам.
