...
3. Проверить, что `BT-012` — бизнес-требование о доставке результата — связано с отправкой готового файла пользователю по электронной почте, уведомлением в Лисе и возвратом статусов вызывающему агенту.
4. Проверить, что пакет спецификаций не включает реальные сетевые, почтовые или интеграции обратного вызова.
