...
| JiraStoryImportContract | Договор воспроизводимого CSV с действующими пользовательскими историями для Jira | active: `schemas/jira-story-import-contract.schema.json` |
