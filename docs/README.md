...
| Открыть исторический прототип или принятый черновик пути презентации в Лисе | [Открыть раздел](product/analysis/presentation-link-lisa-user-journey/README.md), [историческую демонстрацию](product/analysis/presentation-link-lisa-user-journey/demo/index.html), [исторический ZIP-архив](product/analysis/presentation-link-lisa-user-journey/derived/lisa-presentation-user-journey-demo.zip) ([скачать](product/analysis/presentation-link-lisa-user-journey/derived/lisa-presentation-user-journey-demo.zip?raw=true)) или [изолированный черновик](product/analysis/presentation-link-lisa-user-journey/candidate-evidence/prototype-draft/index.html) | Исторический автономный выпуск не подменяет принятый черновик ООО «Водолей Трейд»; чистовая генерация и новый архив заблокированы до отдельного подтверждения. |
