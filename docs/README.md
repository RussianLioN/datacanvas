...
| Открыть принятый черновик пути презентации в Лисе | [Открыть раздел](product/analysis/presentation-link-lisa-user-journey/README.md), [черновой прототип](product/analysis/presentation-link-lisa-user-journey/candidate-evidence/prototype-draft/index.html) или [скачать полный черновой пакет](product/analysis/presentation-link-lisa-user-journey/candidate-evidence/co-2026-003-current-documentation-draft.zip?raw=true) | Принятый 11-кадровый черновик ООО «Водолей Трейд» и полный комплект его текущей документации; чистовой выпуск требует отдельного подтверждения. |
