...
| Открыть чистовой путь заказа презентации в Лисе | [Открыть раздел](product/analysis/presentation-link-lisa-user-journey/README.md), [скачать прототип](../artifacts/delivery/co-2026-003-browser-native-phone-prototype.zip?raw=1) или [скачать полный архив поставки](../artifacts/delivery/co-2026-003-q4-lisa-profile-delivery.zip?raw=1) | Принятый чистовой браузерный прототип ООО «Водолей Трейд»: 11 экранов, рабочая навигация и внешние 4K-экраны. |
