...
| Открыть или скачать интерактивный прототип пути презентации в Лисе | [Открыть раздел](product/analysis/presentation-link-lisa-user-journey/README.md), [запустить демонстрацию](product/analysis/presentation-link-lisa-user-journey/demo/index.html), [скачать ZIP локально](product/analysis/presentation-link-lisa-user-journey/derived/lisa-presentation-user-journey-demo.zip) или [скачать ZIP из GitHub](product/analysis/presentation-link-lisa-user-journey/derived/lisa-presentation-user-journey-demo.zip?raw=true) | Подтверждённый путь от заказа презентации до просмотра и отправки по электронной почте; автономный архив для показа без сети. |
