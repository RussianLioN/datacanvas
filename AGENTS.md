...
- При упоминании кодированного элемента в рабочем диалоге или человекочитаемом артефакте рядом давай краткое описание простыми словами, например: `EDIT-003` — правка бизнес-требований по разделению режимов. Не оставляй код без пояснения, если пользователь или стейкхолдер должен понять смысл без перехода в другой файл.
