...
const expected = [
  ...
  ["B2", "Ценностное предложение", ["презентации", "ручн", "цикл"]],
  ["B3", "Каналы", ["Лис", "A2A", "MCP"]],
  ["B4", "Взаимодействие с пользователем", ["уточня", "прав", "описан"]],
  ["B5", "Потоки внутренней пользы", ["внутрен", "эконом", "финанс"]],
  ["B6", "Ключевые ресурсы", ["PresentationSpec", "шаблон", "renderer"]],
  ["B7", "Ключевые активности", ["достаточн", "генер", "достав"]],
  ["B8", "Ключевые партнеры", ["Оркестратор", "поставщик", "gateway"]],
