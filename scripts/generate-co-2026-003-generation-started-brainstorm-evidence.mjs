...
const ownerIntro = "После принятия данных сообщение должно сохранить время ЧЧ:ММ, обещание «не более 20 минут» и указание, что презентация будет направлена по электронной почте только в SIGMA и OMEGA. Нужен краткий деловой понятный текст о времени и результате без грубых побудительных предложений: нельзя предлагать переключиться, заняться чем-либо или проверить почту. Повторный заказ в той же паре сеанс/пользователь после принятия данных заблокирован.";
