...
- [Скачать полный архив поставки чистового прототипа](artifacts/delivery/co-2026-003-q4-lisa-profile-delivery.zip?raw=true) — автономный ZIP-архив актуальных документов и принятого чистового браузерного прототипа ООО «Водолей Трейд».
- [Открыть чистовой браузерный прототип](docs/product/analysis/presentation-link-lisa-user-journey/candidate-evidence/browser-native-phone-prototype/index.html) — 11 экранов с рабочей навигацией, DOM-текстом в телефоне и внешними 4K-экранами.
...
| Открыть чистовой путь заказа презентации в Лисе | [Открыть раздел](docs/product/analysis/presentation-link-lisa-user-journey/README.md), [браузерный прототип](docs/product/analysis/presentation-link-lisa-user-journey/candidate-evidence/browser-native-phone-prototype/index.html) или [скачать полный архив поставки](artifacts/delivery/co-2026-003-q4-lisa-profile-delivery.zip?raw=true) | Принятый чистовой браузерный прототип ООО «Водолей Трейд»: 11 экранов, рабочая навигация и внешние 4K-экраны. |
