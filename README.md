...
- [Галерея трёх черновых PNG сообщений об ошибках в 13:40](docs/product/analysis/presentation-link-lisa-user-journey/candidate-evidence/frame-review/error-frames-13-40-review.md) — изображения показаны прямо на странице для покадровой приёмки; действующая демонстрация не меняется.
