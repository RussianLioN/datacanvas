...
- [Интегрированный черновик для ООО «Водолей Трейд»](docs/product/analysis/presentation-link-lisa-user-journey/candidate-evidence/prototype-draft/manifest.json) — все 11 согласованных кадров; не изменяет действующую демонстрацию, чистовой рендер или архив.
...
| Открыть исторический прототип или принятый черновик пути презентации в Лисе | [Открыть раздел](docs/product/analysis/presentation-link-lisa-user-journey/README.md), [историческую демонстрацию](docs/product/analysis/presentation-link-lisa-user-journey/demo/index.html), [исторический ZIP-архив](docs/product/analysis/presentation-link-lisa-user-journey/derived/lisa-presentation-user-journey-demo.zip) ([скачать](docs/product/analysis/presentation-link-lisa-user-journey/derived/lisa-presentation-user-journey-demo.zip?raw=true)) или [изолированный черновик](docs/product/analysis/presentation-link-lisa-user-journey/candidate-evidence/prototype-draft/index.html) | Исторический автономный выпуск не подменяет принятый черновик ООО «Водолей Трейд»; чистовая генерация и новый архив заблокированы до отдельного подтверждения. |
