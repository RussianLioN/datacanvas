...
- [Скачать браузерный прототип](artifacts/delivery/co-2026-003-browser-native-phone-prototype.zip?raw=1) — отдельный ZIP для локального запуска 11 принятых экранов ООО «Водолей Трейд».
- [Скачать полный архив поставки](artifacts/delivery/co-2026-003-q4-lisa-profile-delivery.zip?raw=1) — отдельный комплект актуальных документов и доказательств.
...
- [Реестр разрешений и приёмок выпуска](docs/product/change-orders/co-2026-003-release-approval-ledger.md) — итоговое решение владельца по чистовому выпуску, кадрам и архиву поставки.
...
- [Архив поставки чистового прототипа](docs/release/co-2026-003-prototype-delivery-archive.md) — состав актуальной документации, браузерного прототипа и переносимого ZIP-архива.
...
| Открыть чистовой путь заказа презентации в Лисе | [Открыть раздел](docs/product/analysis/presentation-link-lisa-user-journey/README.md), [скачать прототип](artifacts/delivery/co-2026-003-browser-native-phone-prototype.zip?raw=1) или [скачать полный архив поставки](artifacts/delivery/co-2026-003-q4-lisa-profile-delivery.zip?raw=1) | Принятый чистовой браузерный прототип ООО «Водолей Трейд»: 11 экранов, рабочая навигация и внешние 4K-экраны. |
| Импортировать пользовательские истории в Jira | [Руководство по массовому импорту](docs/process/guides/datacanvas-jira-story-bulk-import.md) и [подготовленный CSV](artifacts/generated/jira/datacanvas-stories-2026-q4.csv) | Девять утверждённых историй 2026 года; внешний импорт ещё не выполнялся. |
